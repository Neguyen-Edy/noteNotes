...
import { faRightFromBracket, faFilePen, faFileCirclePlus, faUserGear, faUserPlus } from "@fortawesome/free-solid-svg-icons"
        ...
        <>
            ...
            <header className="dash-header">
                <div className={`dash-header__container ${dashClass}`}>
                    <Link to="/dash">
                        <h1 className="dash-header__title">noteNotes</h1>
                    </Link>
